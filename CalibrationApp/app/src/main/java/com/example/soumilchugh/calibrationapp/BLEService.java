...
//            mCallbacks.onStartedScanning();
            if(mManufacturerID == 1035 && mBLEState == BLEState.CONNECTED){
    ...
    public void getSupportedServices() {
        ...
        sendData(MainActivity.NOTIFY_READ_SUPPORTED_SERVICES,null);
    }
    ...
    public void getResult(byte[] data) throws UnsupportedEncodingException {
        ...
        switch(messageType) {
            case 0x07:
                sendData(MainActivity.NOTIFY_START_MOTOR_CALIBRATION_ACK,null);
                break;
            case 0x08:
                sendData(MainActivity.NOTIFY_UPDATE_MOTOR_CALIBRATION_ACK,null);
                break;
        }
    }
    ...
    private BluetoothGattCallback mBluetoothGattCallback = new BluetoothGattCallback() {
        ...
        public void onServicesDiscovered(BluetoothGatt gatt, int status)
        {
            ...
            sendData(MainActivity.NOTIFY_DISCOVER_SERVICES,null);
        }
        @Override
    ...
    public class BLEServiceBinder extends Binder {
        ...
        public void incrementMotor(byte motorType) {
            byte[] data;
            data = new byte[]{0x16,motorType,0x00};
            if (mBluetoothGatt != null)
                writeCharacteristic(data);
            mBLEState = BLEState.DISCONNECTED;
        ...
        public void decrementMotor(byte motorType) {
            byte[] data;
            data = new byte[]{0x16,motorType,0x01};
            if (mBluetoothGatt != null)
                writeCharacteristic(data);
            mBLEState = BLEState.DISCONNECTED;
        ...
        public void startMotorCalibration(byte MotorType) {
            byte[] data;
            data = new byte[] {0x15,MotorType};
            if (mBluetoothGatt != null)
                writeCharacteristic(data);
        }
    }
