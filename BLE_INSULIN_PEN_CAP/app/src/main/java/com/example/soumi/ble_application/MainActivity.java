...
import com.example.soumi.ble_application.Networkutility.Network;
import com.example.soumi.ble_application.Networkutility.ParseJson;
import com.example.soumi.ble_application.Utilities.WeatherDataPreferences;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        deviceaddresstext = (TextView) (findViewById(R.id.Manu));
        temptext = (TextView) (findViewById(R.id.TempLevel));
        manuIDtext = (TextView) (findViewById(R.id.ManuID));
        batterylevel = (TextView) (findViewById(R.id.Battery));
        tempLevelfromWeb = (TextView) (findViewById(R.id.showtemperature));
        Button gettempfromweb = (Button) (findViewById(R.id.AmbientTemperature));
        gettempfromweb.setOnClickListener(this);
        Button readdata = (Button) (findViewById(R.id.ReadData));
        readdata.setOnClickListener(this);
        Button writename = (Button) (findViewById(R.id.WriteName));
    ...
    public void onClick(View view) {
        ...
        switch (view.getId())
        {
            ...
            case R.id.WriteName:
                ...
                break;
            case R.id.ReadData:
                String devicename = mServiceBinder.getDeviceName();
                String deviceAddress = mServiceBinder.getDeviceAddress();
                if (devicename != null && deviceAddress !=null) {
                    devicenametext.append("-"+ " " + devicename);
                    deviceaddresstext.append("-" + " " + deviceAddress);
                }
                int manuID = mServiceBinder.getManufacturerID();
                if (manuID != 0)
                {
                    manuIDtext.append("-" + " " + String.valueOf(manuID));
                }
                int temperatureLevel = mServiceBinder.getTemperatureLevel();
                if (temperatureLevel != 0)
                {
                    temptext.append("-" + " " + String.valueOf(temperatureLevel));
                }
                int batteryvoltage = mServiceBinder.getBatteryLevel();
                if (batteryvoltage !=0)
                {
                    batterylevel.append("-" + " " + String.valueOf(batteryvoltage));
                }
            break;
...
public void loadweatherdata()
{
    ...
    String location = WeatherDataPreferences.getPreferredWeatherLocation(this);
    new FetchWeatherData().execute(location);

}
    public class FetchWeatherData extends AsyncTask<String,Integer,String>
    {
        @Override
        protected void onPreExecute()
        {
            tempLevelfromWeb.setText("Searching");
            super.onPreExecute();
        }
        @Override
        ...
        protected String doInBackground(String ... params) {
            ...
            try{
                String jsonresponse = Network.getResponseFromHTTP(weatherrequesturl);
                String result = ParseJson.getSimpleStringFromJson(MainActivity.this,jsonresponse);
                return result;
            } catch (IOException e) {
                e.printStackTrace();
        ...
        protected void onPostExecute(String result)
        {
            if (result != null)
            {
                ...
                tempLevelfromWeb.setText(result);
            }
        }
    }
    ...
    protected void Show_dialog()
    {
        ...
        alertdialogbuilder.setCancelable(false).setPositiveButton("OK", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                byte[] values;
                values = device_name.getBytes();
                byte[] c = new byte[values.length + 1];
                byte header = 3;
    ...
    public class ServiceStateReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.getAction().equals("android.action.communication"))
            {
                intent.getStringExtra("connected");
